...
load(file = "models/clinton_rt.rda")
load(file = "models/clinton_fav.rda")
load(file = "models/trump_rt.rda")
load(file = "models/trump_fav.rda")
load(file = "models/congress_rt.rda")

#setwd("~/team-project-team-2/App/")
outputDir <- "App/responses"
...
ui <- dashboardPage(title = 'Tweet Predictor - Team 2', header, sidebar, body, skin='black')
